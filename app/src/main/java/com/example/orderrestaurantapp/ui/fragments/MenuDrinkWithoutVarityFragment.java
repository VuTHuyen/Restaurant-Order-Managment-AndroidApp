...
import com.example.orderrestaurantapp.ui.adapters.MenuDrinkWithoutVarityAdapter;

import java.util.List;

public class MenuDrinkWithoutVarityFragment extends Fragment {
    private MenuDrinkWithoutVarityAdapter adapter;
    private Bundle bundle;
    public static MenuDrinkWithoutVarityFragment newInstance() {
        MenuDrinkWithoutVarityFragment fragment = new MenuDrinkWithoutVarityFragment();
        return fragment;
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        List<DrinkWithoutVarity> drinks = MenuReader.getMenuDrinksWVOfRestaurant(assetManager, "DrinksWithoutVarity.csv");
        adapter = new MenuDrinkWithoutVarityAdapter(this.getContext(), drinks,refId, getActivity(), getResources());
                                ...
                                searchView.setOnQueryTextListener(
                                        new SearchView.OnQueryTextListener() {
                                            ...
                                            public boolean onQueryTextSubmit(String query) {
                                                ...
                                                ((MenuDrinkWithoutVarityAdapter) adapter).query_filter_all(query);
                                                return true;
                                            }
                                            ...
                                            public boolean onQueryTextChange(String searchQuery) {
                                                ...
                                                ((MenuDrinkWithoutVarityAdapter) adapter).query_filter_all(searchQuery);
                                                return true;
                                            }
                                        });
