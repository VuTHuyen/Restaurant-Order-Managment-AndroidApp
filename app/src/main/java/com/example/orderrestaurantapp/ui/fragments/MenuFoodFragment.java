...
public class MenuFoodFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        List<Food> foods = MenuReader.getMenuFoodOfRestaurant(assetManager, "Foods.csv");

        recyclerView.setItemViewCacheSize(100000);
        adapter = new MenuFoodAdapter(this.getContext(), foods,refId, getActivity(), getResources());
                                ...
                                searchView.setOnQueryTextListener(
                                        new SearchView.OnQueryTextListener() {
                                            ...
                                            public boolean onQueryTextSubmit(String query) {
                                                ...
                                                ((MenuFoodAdapter) adapter).query_filter_all(query);
                                                return true;
                                            }
                                            ...
                                            public boolean onQueryTextChange(String searchQuery) {
                                                ...
                                                ((MenuFoodAdapter) adapter).query_filter_all(searchQuery);
                                                return true;
                                            }
                                        });
