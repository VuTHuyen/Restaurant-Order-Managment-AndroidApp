...
import com.example.orderrestaurantapp.ui.adapters.MenuDrinkTwoFourAdapter;
...
public class MenuDrinkTwoFourFragment extends Fragment {
    private MenuDrinkTwoFourAdapter adapter;
    private FirebaseFirestore database;
    private Bundle bundle;
    public static MenuDrinkTwoFourFragment newInstance() {
        return new MenuDrinkTwoFourFragment();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        List<DrinkVarietyTwoFour> drinks = MenuReader.getDrinkVarietyTwoFour(assetManager, "Drinks24.csv");
        adapter = new MenuDrinkTwoFourAdapter(this.getContext(), drinks, refId, getActivity(), getResources());
                                ...
                                searchView.setOnQueryTextListener(
                                        new SearchView.OnQueryTextListener() {
                                            ...
                                            public boolean onQueryTextSubmit(String query) {
                                                ...
                                                ((MenuDrinkTwoFourAdapter) adapter).query_filter_all(query);
                                                return true;
                                            }
                                            ...
                                            public boolean onQueryTextChange(String searchQuery) {
                                                ...
                                                ((MenuDrinkTwoFourAdapter) adapter).query_filter_all(searchQuery);
                                                return true;
                                            }
                                        });
